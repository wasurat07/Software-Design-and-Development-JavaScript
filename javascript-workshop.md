...
3. แบบ External Script: เขียน script ในไฟล์แล้วเรียกใข้ใน HTML
   ไฟล์ script.js มีข้อมูลดังนี้
```javascript
    alert('สวัสดี!');
```
   ไฟล์ HTML มีการเรียกใข้ script ดังนี้
```html
...
1. สร้างหน้าเว็บที่มีปุ่ม 3 ปุ่ม:
   - ปุ่มที่ 1: ใช้ Inline JavaScript แสดงชื่อของคุณ
...
2. เพิ่มกล่องข้อความและปุ่มสำหรับแสดงผล:
   - มีช่องกรอกข้อความ
   - มีปุ่มที่เมื่อคลิกแล้วจะแสดงข้อความที่กรอก
  
[](#การทดลองที่-2-พื้นฐาน-JavaScript)
## การทดลองที่ 2: พื้นฐาน JavaScript
[](##การทดลองที่-2.1-การประกาศตัวแปรและชนิดข้อมูล)
...
[](##การทดลองที่-2.2-การดำเนินการทางคณิตศาสตร์)
...
[](##การทดลองที่-2.3-การคุมคุมการทำงาน)
...
[](##การทดลองที่-2.4-Function-และ-Arrow-Function)
...
[](#การทดลองที่-3-การใช้-JavaScript-ร่วมกับ-HTML-และ-CSS)
